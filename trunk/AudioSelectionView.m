...
#include <unistd.h>
#include "AudioSelectionView.h"
#import "CSPreferencesTableCell.h"

@implementation AudioSelectionView : UIView
...
- (id) initWithApplication: (UIApplication*)app withAppID: (NSString*)appID withFrame: (struct CGRect)rect
{
	...
	UINavigationItem* title = [[UINavigationItem alloc] initWithTitle:@"Sounds"];
...
- (void) buildPreferencesTable
{
	...
	CSPreferencesTableCell* cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	UIImage* cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Unlock Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"unlockSoundChooser"];
	...
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Lock Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"lockSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Received Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"receivedSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Sent Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"sentSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Voicemail Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"voicemailSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Alarm Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"alarmSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Beep Beep Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"beepBeepSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Low Power Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"lowPowerSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Mail Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"mailSentSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"New Mail Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"newMailSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"Photo Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"photoSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
	
	cell = [[CSPreferencesTableCell alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 300.0f, 42.0f)];
	cellIcon = [UIImage imageAtPath:@"/Applications/Customize.app/icons/notes.png"];
	[cell setIcon:cellIcon];
	[cell setTitle:@"SMS Received Sound"];
	[cell setShowDisclosure:YES];
	[cell setCellOutline:1];
	[cell setView:@"smsReceivedSoundChooser"];
	[[_prefCells objectAtIndex:([_prefCells count]-1)] addObject: cell];
